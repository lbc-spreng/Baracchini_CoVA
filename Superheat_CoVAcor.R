...
data <- readMat("Rearranged_Correlation_matrix_FCrun2-zMSSDrun1_young_finalsample_reversed.mat")
setwd("/Users/giulia/Desktop/McGill_PhD/CoVA_PhD1/xlsx_csv_files")
...
# # Fc1-zMSSD2
# within <- c(0.0645,0,0956,0.0577,0.0694,0.0222,0.0389,0.0389)
# between <- c(-0.0113,0.0153,0.0185,0.0159,-0.0044,0.0057,-0.0026)
# Fc2-zMSSD1
within <- c(0.0641,0.1088,0.0796,0.0662,0.0186,0.0451,0.0431)
between <- c(0.0094,0.0248,0.0272,0.0383,0.0091,0.0285,0.0159)

pal <- rev(brewer.pal(5,"RdBu"))

png("superheat_unperm_corr_fc2mssd1_young_reversed.png", height = 900, width = 800, units='mm', res=500)
